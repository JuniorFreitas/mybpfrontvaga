...
function valida_cep_vazio(obj) {
  ...
  if (valor.length == 0) {
    ...
    if (
      ($(obj).siblings("div.invalid-feedback").length == 0 ||
        $(obj).siblings("div.input-group-append").length == 0) &&
      !$(obj).attr("data-toggle")
    ) {
      if ($(obj).siblings("div.input-group-append").length) {
        $(obj)
      ...
      if (
        ...
        if ($(obj).siblings("div.input-group-append").length) {
          $(obj)
            .next("div.input-group-append")
            .eq(0)
            .after(`<div class="invalid-feedback">Exemplo: 65000-000</div>`);
        } else {
          $(obj).after(
    ...
    if (
      ...
      if ($(obj).siblings("div.input-group-append").length) {
        $(obj)
          .siblings("div.input-group-append")
          .after(
            `<div class="invalid-feedback">O valor não pode ser 0,00</div>`
          );
      } else {
        $(obj).after(
          `<div class="invalid-feedback">O valor não pode ser 0,00</div>`
